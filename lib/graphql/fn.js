...
var _require2 = require('graphql-relay'),
    connectionArgsBase = _require2.connectionArgs,
    connectionDefinitionsBase = _require2.connectionDefinitions,
    connectionFromArray = _require2.connectionFromArray,
    connectionFromArraySlice = _require2.connectionFromArraySlice,
    cursorToOffset = _require2.cursorToOffset,
    GraphQLResolveInfo = _require2.GraphQLResolveInfo; // eslint-disable-line import/no-extraneous-dependencies
